...
## Recherche de codes ou de fonctions

Pour ce premier exercice, je vous demande d'ordonner un tableau de données en ordre décroissant selon le numéros de ferme et un numéro d'échantillon.

Par la suite, vous devez trouver une fonction permettant de grouper les sites selon leur similarité en terme de.
...
[Statistics for terrified biologists](): La série de Highland Statistics, les *Zuur*

[La série des *Zuur*](): Highland Statistics

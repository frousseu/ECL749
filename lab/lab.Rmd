...
- **Introduction** : court texte présentant et mettant en contexte la question posée et les
...
- **Annexe** : code R utilisé pour effectuer les analyses statistiques
...
Quels sont les caractéristiques du paysage affectant la présence dde la Chouette rayée (*i.e.* une espèce de hibou, *Strix varia*) dans le sud du Québec? Est-ce que le Grand-duc d'Amérique (*Bubo virginianus*) à une influence sur sa présence?

<br>

**2. Richesse ichtyologique dans les récif coraliens**

Quels sont les variables influençant la richesse en poissons dans les récifs coraliens?

<br>

**3. Diversité aviaire, forêt et fragmentation en milieu tropical**

Quel est l'effet de la fragmentation et de la forêt mature sur la richesse aviaire en milieu tropical?

<br>

**4. L'abondance des moineaux dans un contexte agricole**

Quels sont les éléments du paysage affectant l'abondance du moineau domestique en milieu agricole dans le sud du Québec?

<br>

**5. La diversité des papillons dans les prairies naturelles**

Quelles sont les caractéristiques de la végétation affectant la diversité en espèce de papillons dans les prairies naturelles
...
[R Spatial](http://www.rspatial.org/): introduction à R pour l'analyse de données et la modélisation spatiales

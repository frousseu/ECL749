...
Voici la base de données [chouette]("https://raw.githubusercontent.com/frousseu/ECL749/master/data/chouette.csv") et une description des variables:
...
-**for_feuil**: % de forêt perturbée ou secondaire
...
Voici la base de données [poissons_coraux]("https://raw.githubusercontent.com/frousseu/ECL749/master/data/poissons_coraux.csv") et une description des variables:
...
-**complexité**: indice de complexité du relief variant de 1 (peu complexe) à 5 (très complexe)
-**pente**: pente générale de la section de récif échantillonnée
...
Voici la base de données [moineaux]("https://raw.githubusercontent.com/frousseu/ECL749/master/data/moineaux.csv") et une description des variables:
...
-**supbat_500**: % de bâtiments (surface) dans un rayon de 500m
-**peribat500mean**: périmètre total de bâtiments dans un rayon de 500m (en mètres)
-**perim500mean_km**: périmètre total de bâtiments dans un rayon de 500m (en km)
...
Voici la base de données [papillons]("https://raw.githubusercontent.com/frousseu/ECL749/master/data/papillons.csv") et une description des variables:

-**site**: site de récolte
-**habitat**: type d'habitat (champs de foin, graminées courtes, graminés grandes, mixtes)

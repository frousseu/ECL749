...
En utilisant le package **ggeffects** plutôt que visreg, on peut obtenir des intervalles de confiance approximatifs qui nous aident un peu plus à ce faire une idée de l'incertitude que nous avons dans l'estimation de nos effets. Ce package permet également un peu plus de flexibilité dans la visualisation des modèles comparativement à visreg. En combinaison avec le package [**patchwork**](https://patchwork.data-imaginist.com/index.html), il est facile d'organiser les différents graphiques dans une même fenêtre.

...
g1<-plot(g1,rawdata=TRUE)
g2<-ggpredict(m,terms=c("exposition[n=50]"))
g2<-plot(g2,rawdata=TRUE)
g3<-ggpredict(m,terms=c("Type"))
g3<-plot(g3,rawdata=FALSE)
